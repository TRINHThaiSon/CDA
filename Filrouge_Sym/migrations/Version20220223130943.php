 ...
 */
final class Version20220223130943 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sous_categories ADD categorie_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sous_categories DROP categorie_id, CHANGE num_souscat num_souscat VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE nom_souscat nom_souscat VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE image_souscat image_souscat VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
